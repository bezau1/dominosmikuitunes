...
var t=this.newHeight+15,n=this.newWidth,r=this.videoWrapper.getAttribute("poster"),i=document.getElementsByTagName("source")[0],s=i.getAttribute("src"),o="tofit",u='<object width="'+n+'" height="'+t+'" '+'classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" '+'codebase="https://web.archive.org/web/20130722042659/http://www.apple.com/qtactivex/qtplugin.cab" scale="'+o+'"> '+'<param name="src" value="'+s+'"> '+'<param name="autoplay" value="true"> '+'<param name="poster" value="'+r+'"> '+'<param name="controller" value="true"> '+'<param name="scale" value="'+o+'"> '+'<embed src="'+s+'" width="'+n+'" height="'+t+'" '+'scale="'+o+'" '+'controller="true" autoplay="true" poster="'+r+'" '+'pluginspage="https://web.archive.org/web/20130722042659/http://www.apple.com/quicktime/download/"> '+"</embed> "+"</object>",a=document.createElement("div");
...
for(i=0;
i<t.length;
i++)t[i].className=="spinner"&&(t[i].className="no-spinner")},1e4),document.getElementsByTagName("body")[0].className+=" itunes-detected"):document.getElementsByTagName("body")[0].className+=" itunes-not-detected"},itunesDownloadUrl:"https://web.archive.org/web/20130722042659/http://apple.com/itunes/download",itunesDetectorElement:document.getElementById("iTunesDetectorIE"),macAppStoreDetectedCallback:function(e,t){e?document.getElementsByTagName("body")[0].className+=" mac-app-store-detected":document.getElementsByTagName("body")[0].className+=" mac-app-store-not-detected"},macAppStoreDownloadUrl:"https://web.archive.org/web/20130722042659/http://www.apple.com/mac/app-store/"}}}(),Tracklist={toHover:"div.track-list tbody tr",url:null,isSocial:null,init:function(){this.url=this.getURL(),this.isSocial=document.body.className.match(/song/);
...
!t&&e.getAttribute("adam-id")==n.url&&(e.className=e.className+" selected",t=!0,setTimeout(function(){var t=$(e).offset().top-$(window).height();
t-$(window).scrollTop()>0&&$(window).scrollTop(t+30)},1e3)),its.x.addEventListener(e,"mouseover",function(e){return r&&(r.className=r.className+" borderless"),!1}),its.x.addEventListener(e,"mouseout",function(e){return r&&(r.className=r.className.replace("borderless","")),!1})})}},previousRow:function(e){if(e){p=e;
...
/*
     FILE ARCHIVED ON 04:26:59 Jul 22, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:11:17 Mar 18, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 15.735
  load_resource: 744.648 (2)
  PetaboxLoader3.resolve: 582.006 (2)
  PetaboxLoader3.datanode: 274.486 (5)
  captures_list: 0.67
  exclusion.robots: 0.04
  exclusion.robots.policy: 0.028
  esindex: 0.009
  cdx.remote: 111.909
  LoadShardBlock: 250.225 (3)
*/