...
function ITSStopwatch(e){this.reset(),e||(e="default"),this._name=e,this._hasLoggedToServer=!1,ITSStopwatch.stopwatches||(ITSStopwatch.stopwatches={}),ITSStopwatch.stopwatches[e]=this}window.its||(window.its={}),its.isDefined=function(t){return typeof t!="undefined"},its.isDefinedNonNull=function(t){return its.isDefined(t)&&t!=null},window.EXCEPTION_LOGGER_NAME="ITSExceptionHandler",window._itsOnErrorCallback=function(t,n,r){if(t&&t instanceof Event){var i=t.target;
...
t=t?t:1e3,ITSLogger._queuedMessages&&ITSLogger._queuedMessages.length&&t>0&&ITSLogger._delayedProcessQueuedMessages(t)},ITSLogger._processQueuedMessages=function(){ITSLogger.possiblyWaitForQueueMessages()},ITSLogger._delayedProcessQueuedMessages=function(t){window.setTimeout(ITSLogger._processQueuedMessages,t)},ITSStopwatch.named=function(t){var n=null;
...
/*
     FILE ARCHIVED ON 04:26:54 Jul 22, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:11:03 Mar 18, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 23.32
  load_resource: 438.994 (2)
  PetaboxLoader3.resolve: 325.6 (3)
  PetaboxLoader3.datanode: 316.795 (5)
  captures_list: 0.55
  exclusion.robots: 0.019
  exclusion.robots.policy: 0.009
  esindex: 0.009
  cdx.remote: 104.22
  LoadShardBlock: 261.063 (3)
*/