...
return i},its.string._xmlEscapeMap={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},its.string.xmlEscape=function(e){var t=e;
if(typeof t!="undefined"&&t!=null){typeof t!="string"&&(t=t.toString());
var n=its.string._xmlEscapeMap;
t=t.replace(/[&<>"']/g,function(e){return n[e]})}return t},its.string.xmlUnescape=function(t){return t.replace(/&apos;/g,String.fromCharCode(39)).replace(/&quot;/g,'"').replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&")},its.string.htmlUnescape=function(t){var n=document.createElement("textarea");
n.innerHTML=t.replace(/</g,"&lt;").replace(/>/g,"&gt;");
var r=n.value;
return n.remove(),r},its.string.urlDecode=function(t){var n=t;
...
return n=="false"?n=!1:n=="true"?n=!0:/(^-?\d\d*\.\d*$)|(^-?\d\d*$)|(^-?\.\d\d*$)/.test(n)&&(isFinite(parsedNumber=parseFloat(n))?n=parsedNumber:isFinite(parsedNumber=parseInt(n,10))&&(n=parsedNumber)),n},window.its.reflect||(window.its.reflect={}),its.reflect.keys=function keys(e){var keys=[];
...
i===-1&&(i=t.length),n=t.substring(r,i)}}return n},its.url.finalPathComponent=function(t){var n="";
if(t){t=t.toString();
...
return its.url.appendUrlParametersString(t,r)},its.url.appendUrlParametersString=function(t,n){if(!n)return t;
var r=t.indexOf("?")===-1?"?":"&";
...
return its.url.appendUrlParametersString(n,r.join("&"))},its.url.baseUrl=function(t){var n=t.indexOf("?");
if(n===-1){n=t.indexOf("#");
...
return n&&(n=unescape(n)),n},its.cookies.setUnescaped=function(t,n,r,i,s){var o="",u="";
if(r){var a=new Date;
a.setTime(a.getTime()+r*1e3),o=a.toUTCString()}i||(i="/"),s&&(u=" domain="+s);
...
if(c&&(l||r<0)){var h=document.cookie=f;
if(l)return h}return its.cookies._setRaw(f)},its.cookies.getUnescaped=function(t){var n=its.cookies._debugAndUnitTestCookieGetterWithRawCookieStringOverride||its.cookies._getRaw();
if(n&&t){its.cookies._debugAndUnitTestCookieGetterWithRawCookieStringOverride=null;
var r=n.split(";"),i=null;
for(var s=r.length-1;
!i&&s>=0;
s--){var o=r[s],u=o.indexOf("=");
if(u>0)if(u+1==o.length)i="";
else{var a=its.string.trim(o.substring(0,u));
a==t&&(its.cookies._debugAndUnitTestLastRawGetCookieString=o,i=its.string.trim(o.substring(u+1)))}}}return i},its.cookies.remove=function(t,n){return its.cookies.setUnescaped(t,"",its.cookies.EXPIRE_NOW,null,n)},its.cookies._cookieOwner="iTunes"in window&&"cookie"in iTunes?"iTunes":"document",its.cookies._setRaw=function(e){return window[this._cookieOwner].cookie=e},its.cookies._getRaw=function(){return window[this._cookieOwner].cookie||""},typeof iTSLocalization=="undefined"&&(iTSLocalization=new Object),iTSLocalization._lookup=function(e){var t=iTSLocalization._strings;
for(var n in t)if(t.hasOwnProperty(n)){var r=t[n];
if(r.hasOwnProperty(e))return r[e]}},iTSLocalization.hasLocalizedValue=function(t){var n=iTSLocalization._lookup(t);
return its.isDefined(n)},its.loc=function(e,t){var n=iTSLocalization._lookup(e);
return typeof n=="undefined"&&(n=e),t&&(n=iTSLocalization.replaceTokens(n,t)),n=iTSLocalization.replaceMarkupTokens(n,t),n},iTSLocalization._lookup("_showLocKeys")&&(its.loc=function(e){return"+"+e+"+"}),its.locWithCount=function(e,t,n){return e===1?its.loc(t):its.loc(n,{count:e})},iTSLocalization.replaceTokens=function(t,n){if(n)for(var r in n)if(n.hasOwnProperty(r)){var i="@@"+r+"@@";
t=t.replace(new RegExp(i,"g"),n[r])}return t},iTSLocalization.markupParams={nbsp:"&nbsp;",gt:"&gt;",lt:"&lt;",copy:"©"},iTSLocalization.replaceMarkupTokens=function(t,n){if(t.indexOf("##")>-1){if(n)for(var r in n)iTSLocalization.markupParams[r.toString()]=n[r];
...
var r=n?"https://web.archive.org/web/20130722042658/https://s.mzstatic.com":"https://web.archive.org/web/20130722042658/http://r.mzstatic.com";
return r+its.loc(t)},its.formatNumber=function(e,t){if(typeof iTSLocalization.decimalSeparator=="undefined"){var n=iTSLocalization._lookup("_decimalSeparator");
typeof n=="undefined"&&(n="."),iTSLocalization.decimalSeparator=n,n=iTSLocalization._lookup("_thousandsSeparator"),typeof n=="undefined"&&(n=","),iTSLocalization.thousandsSeparator=n}var r=!0;
t&&t.hasOwnProperty("useGrouping")&&(r=t.useGrouping);
var i=e.toString().split(".");
if(r){var s=iTSLocalization.thousandsSeparator,o=i[0].split("");
for(var u=o.length-3;
u>0;
u-=3)o.splice(u,0,s);
i[0]=o.join("")}var a=i.join(iTSLocalization.decimalSeparator);
return a},its.isXMLResponse=function(e){return e&&its.string.startsWith(e.getResponseHeader("content-type"),"text/xml")},its.notifications={_listeners:{},subscribe:function(e,t){var n=this._listeners[e];
n||(this._listeners[e]=n=[]),n.push(t)},unsubscribe:function(e,t){var n=this._listeners[e];
if(!n)return;var r=n.indexOf(t);
r>=0&&n.splice(r,1)},publish:function(e,t){this._sendNotification(this._listeners[e],t)},remove:function(e){var t=this._listeners[e];
if(!t)return;delete this._listeners[e]},hasListeners:function(e){return this._listeners[e]?!0:!1},_sendNotification:function(e,t){if(!e)return;for(var n=0,r=e.length;
n<r;
n++)e[n]&&e[n](t)}},its.plistDictGetValue=function(t,n){if(!t)return;var r=t.childNodes.length,i=null;
for(var s=0;
s<r;
...
break}u.nodeName==="key"&&u.textContent===n&&(i=u)}}i&&s&&(t.removeChild(i),t.removeChild(s))},its._dataCache={},its.property=function(e,t){return its.value("its.serverData.properties",e,!0,t)},its.pageData=function(e,t){return its.value("its.serverData.pageData",e,!0,t)},its.valueOverride=function(e,t){var n;
return t||(n=its._dataCache[e]),n==undefined&&(n=its.string.unstringify(its.url.originalLocationQueryParams[e])),n==undefined&&(n=its.string.unstringify(sessionStorage[e])),n==undefined&&(n=its.string.unstringify(localStorage[e])),n==undefined&&(n=window[e],n==undefined&&window.its&&(n=window.its[e])),!t&&its.isDefined(e)&&its.isDefined(n)&&(its._dataCache[e]=n),n},its.value=function(dataPath,key,useOverrideIfAvailable,noCache){var returnValue;
useOverrideIfAvailable&&(returnValue=its.valueOverride(key,noCache));
if(returnValue==undefined){noCache||(returnValue=its._dataCache[key]);
if(returnValue==undefined){var objectAtDataPath;
try{objectAtDataPath=eval(dataPath)}catch(anException){}objectAtDataPath!=undefined&&(returnValue=objectAtDataPath[key]);
if(returnValue==undefined)try{returnValue=eval(dataPath+"."+key)}catch(anException){}}}return!noCache&&its.isDefined(key)&&its.isDefined(returnValue)&&(its._dataCache[key]=returnValue),returnValue},its.setPropertyOverride=function(e,t,n){return its.setValueOverride(e,t,n)},its.setPageDataOverride=function(e,t,n){return its.setValueOverride(e,t,n)},its.setValueOverride=function(e,t,n){var r=null;
e?its.isDefined(t)||(r="Invalid value"):r="Invalid key";
if(r)throw new Error(r+". Usage: setProperty(key, value, usePermanentStorage)");
var i=null;
delete its._dataCache[e],its.removeValueOverride(e);
var s=null;
return n?s=localStorage:s=sessionStorage,s[e]=t,i=s[e],i},its.removePropertyOverride=function(e){return its.removeValueOverride(e)},its.removePageDataOverride=function(e){return its.removeValueOverride(e)},its.removeValueOverride=function(key){delete its._dataCache[key],sessionStorage.removeItem(key),localStorage.removeItem(key);
try{returnValue=eval("delete window."+key)}catch(anException){}if(returnValue==undefined)try{returnValue=eval("delete window.its."+key)}catch(anException){}return key},its.flushDataCache=function(){its._dataCache={}},its.screenReaderRunning=function(){if(typeof iTunes!="undefined"){if(iTunes.hasOwnProperty("screenReaderRunning"))return iTunes.screenReaderRunning;
if(iTunes.screenReaderRunning&&typeof iTunes.screenReaderRunning=="function")return iTunes.screenReaderRunning()}return!1}(),function(e,t){function n(){if(!y.isReady){try{E.documentElement.doScroll("left")}catch(e){setTimeout(n,1);
...
/*
     FILE ARCHIVED ON 04:26:58 Jul 22, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:11:07 Mar 18, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 42.395
  load_resource: 538.454 (2)
  PetaboxLoader3.resolve: 874.797 (5)
  PetaboxLoader3.datanode: 272.276 (5)
  captures_list: 0.692
  exclusion.robots: 0.033
  exclusion.robots.policy: 0.013
  esindex: 0.011
  cdx.remote: 43.659
  LoadShardBlock: 685.788 (3)
*/